...
public class TransactionService {
    ...
    private Transaction saveAndGetTransaction(TransactionType transactionType, TransactionResultType f,Account account,Long amount){
    ...
    public TransactionDto cancelBalance(String transactionId, String accountNumber, Long amount){
        ...
        Transaction transaction = transactionRepository.findTransactionId(transactionId)
    ...
    public TransactionDto queryTransaction(String transactionId){
        ...
        return TransactionDto.fromEntity(
                transactionRepository.findTransactionId(transactionId)
                        .orElseThrow(()-> new AccountException((ErrorCode.TRANSACTION_NOT_FOUND)))
        );
    }
}
