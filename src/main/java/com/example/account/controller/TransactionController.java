...
public class TransactionController {
    ...
    public UseBalance.Response useBalanace(
    ...
    public CancelBalance.Response cancelBalanace(
    ...
    @GetMapping("transaction/{transaactionId}")
    public QueryTransactionResponse queryTransaction(
            @PathVariable String transaactionId){
        return QueryTransactionResponse.from(transactionService.queryTransaction(transaactionId));
    }
